...
알림 권한을 허용하지 않은 경우, 다음 단계를 따라 브라우저 설정에서 알림을 활성화하세요.

#### 1. Chrome(크롬)

1. 브라우저 우측 상단의 **세 점 메뉴**를 클릭합니다.
2. **설정** > **개인정보 및 보안** > **사이트 설정**을 선택합니다.
3. **권한** 섹션에서 **알림**을 클릭합니다.
4. 사이트 리스트에서 `https://devterview.com`을 찾아 **허용**으로 변경합니다.

#### 2. Firefox(파이어폭스)

1. 브라우저 우측 상단의 **세 줄 메뉴**를 클릭하고 **설정**을 선택합니다.
2. **개인 정보 및 보안** > **권한** 섹션으로 이동합니다.
3. **알림** 옆에 있는 **설정** 버튼을 클릭합니다.
4. 사이트 리스트에서 `https://devterview.com`을 찾아 **허용**으로 변경합니다.

#### 3. Edge(엣지)

1. 브라우저 우측 상단의 **세 점 메뉴**를 클릭합니다.
2. **설정** > **쿠키 및 사이트 권한** > **알림**을 선택합니다.
3. 사이트 리스트에서 `https://devterview.com`을 찾아 **허용**으로 변경합니다.

#### 4. Safari(사파리)

1. 브라우저 상단 메뉴에서 **Safari** > **환경설정**을 선택합니다.
2. **웹사이트** 탭에서 **알림**을 선택합니다.
3. `https://devterview.com`을 찾아 **허용**으로 변경합니다.

#### 5. Whale(웨일)

1. 브라우저 우측 상단의 **세 줄 메뉴**를 클릭합니다.
2. **설정** > **개인정보 보호 및 보안** > **사이트 설정**으로 이동합니다.
3. **권한** 섹션에서 **알림**을 선택합니다.
4. 사이트 리스트에서 `https://devterview.com`을 찾아 **허용**으로 변경합니다.
5. 알림 권한 요청 창이 다시 나타나지 않는다면, **데이터 삭제** 또는 **권한 초기화**를 진행합니다.

#### 6. 기타

- 알림 권한 요청 창이 다시 나타나지 않는다면, 사이트 데이터를 삭제하거나 브라우저를 재설정하세요.

---

추가적으로, 알림 권한 허용은 서비스 이용 시작 시 자동으로 요청됩니다. 허용하지 않았을 경우 위 단계를 따라 설정을 변경해주세요.
